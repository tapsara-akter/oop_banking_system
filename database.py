...
class MySQLdb:
    ...
    def insert_data(self, table_name):
        try:
            connection = self.connect_mysql(database='bank')
            cursor = connection.cursor()
            sql = "INSERT INTO " + table_name + "(id, name, account) VALUES(1, 'Monir', '10000')"
            sql2 = "INSERT INTO " + table_name + "(id, name, account) VALUES(2,'Amin', '1050000')"
            sql3 = "INSERT INTO " + table_name + "(id, name, account) VALUES(3, 'kamal', '53000')"
            # val = (id, name, account)
